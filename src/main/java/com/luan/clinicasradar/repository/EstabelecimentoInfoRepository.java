...
public interface EstabelecimentoInfoRepository extends JpaRepository<EstabelecimentoInfo, String> {
    ...
    @Query(value = "select * from clinicasradar.estabelecimento_info where latitude is null and situacao like 'ATIVA' and cnpj not in ('53894218000101','51102697000142','53638649000107') limit 1",nativeQuery = true)
