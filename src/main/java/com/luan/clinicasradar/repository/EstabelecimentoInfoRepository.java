...
public interface EstabelecimentoInfoRepository extends JpaRepository<EstabelecimentoInfo, String> {
    ...
    @Query(value = "select * from clinicasradar.estabelecimento_info where latitude is null and situacao like 'ATIVA' and cnpj not like '53894218000101' limit 1",nativeQuery = true)
